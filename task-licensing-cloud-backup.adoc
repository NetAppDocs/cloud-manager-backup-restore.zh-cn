...
使用Azure时、请联系您的NetApp销售代表以购买年度合同。此合同在Azure Marketplace中以私人优惠形式提供。

在NetApp与您共享私有优惠后、您可以在Cloud Backup激活期间从Azure Marketplace订阅年度计划。
...
在NetApp与您共享私有优惠后、您可以在Cloud Backup激活期间从Google Cloud Marketplace订阅年度计划。
